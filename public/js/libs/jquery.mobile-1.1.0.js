...
// Thanks to Modernizr src for this test idea. `perspective` check is limited to Moz to prevent a false positive for 3D transforms on Android.
        function transform3dTest () {
            ...
            return validStyle('perspective', '10px',
                'moz') || $.mobile.media("(-" + vendors.join("-" + prop + "),(-") + "-" + prop + "),(" + prop + ")");
        }
...
//transition handler dictionary for 3rd party transitions
    ...
    (function ( $, undefined ) {
        ...
        //initial value. If a base tag does not exist, then we default to the documentUrl.
            documentBase = $base.length ? path.parseUrl(path.makeUrlAbsolute($base.attr("href"),
                documentUrl.href)) : documentUrl,
        ...
        $.mobile._registerInternalEvents = function () {
            ...
            $.mobile._handleHashChange = function ( hash ) {
                ...
                if ( to ) {
                    ...
                    to = ( typeof to === "string" && !path.isPath(to) ) ? ( path.makeUrlAbsolute('#' + to,
                        documentBase) ) : to;
            ...
            _create: function () {
                ...
                $el.bind("vclick submit", function ( event ) {
                    ...
                    if ( $target.length && !$target.jqmData("transition") ) {
                        ...
                        $target.attr("data-" + $.mobile.ns + "transition",
                            ( active.transition || $.mobile.defaultDialogTransition ))
            ...
            for ( var i = 0; i < $workingSet.length; i++ ) {
                var el = $workingSet.eq(i),
                    ...
                    o = $.extend({}, $.fn.buttonMarkup.defaults, {
                        ...
                        theme     : options.theme !== undefined ? options.theme : el.jqmData("theme") || $.mobile.getInheritedTheme(el,
                            "c"),
                ...
                buttonElements = $.data(((e.tagName === "INPUT" || e.tagName === "BUTTON") ? e.parentNode : e),
                    "buttonElements");
                ...
                collapsible
                    .bind("expand collapse", function ( event ) {
                        if ( !event.isDefaultPrevented() ) {
                            ...
                            collapsibleContent.toggleClass("ui-collapsible-content-collapsed",
                                isCollapse).attr("aria-hidden", isCollapse);
                        ...
                        .bind("expand collapse", function ( event ) {
                            ...
                            if ( contentTheme && collapsible.jqmData("collapsible-last") ) {
                                collapsible.find(widget.options.heading).first()
                                    ...
                                    .add(".ui-btn-inner")
                                    .toggleClass("ui-corner-bottom", isCollapse);
                                collapsible.find(".ui-collapsible-content").toggleClass("ui-corner-bottom",
                                    !isCollapse);
                            }
                        })
                ...
                for ( i = 0; i < len; i++ ) {
                    ...
                    if ( img.length ) {
                        ...
                        $(this._findFirstElementByTagName(img[ 0 ].parentNode, "parentNode", "li",
                            "LI")).addClass(img.is(".ui-li-icon") ? "ui-li-has-icon" : "ui-li-has-thumb");
                    }
                }
            },
    ...
    (function ( $, undefined ) {
        ...
        $.fn.controlgroup = function ( options ) {
            ...
            return this.each(function () {
                ...
                flipClasses($el.find(".ui-btn" + ( o.excludeInvisible ? ":visible" : "" )).not('.ui-slider-handle'),
                    flCorners);
        ...
        var extendSelect = function ( widget ) {
            ...
            if ( widget.isMultiple ) {
                headerClose = $("<a>", {
                    ...
                    "href" : "#",
                    "class": "ui-btn-left"
                }).attr("data-" + $.mobile.ns + "iconpos", "notext").attr("data-" + $.mobile.ns + "icon",
                    "delete").appendTo(header).buttonMarkup();
            }
                    ...
                    .bind("pagebeforehide", function ( e, ui ) {
                        ...
                        if ( o.trackPersistentToolbars ) {
                            var thisFooter = $(".ui-footer-fixed:jqmData(id)", this),
                                ...
                                nextFooter = thisFooter.length && ui.nextPage && $(".ui-footer-fixed:jqmData(id='" + thisFooter.jqmData("id") + "')",
                                    ui.nextPage),
                                nextHeader = thisHeader.length && ui.nextPage && $(".ui-header-fixed:jqmData(id='" + thisHeader.jqmData("id") + "')",
                                    ui.nextPage);
        ...
        $(document)
            .bind("pagecreate create", function ( e ) {
                ...
                if ( $(e.target).jqmData("fullscreen") ) {
                    $($.mobile.fixedtoolbar.prototype.options.initSelector,
                        e.target).not(":jqmData(fullscreen)").jqmData("fullscreen", true);
                }
            ...
            showPageLoadingMsg: function ( theme, msgText, textonly ) {
                ...
                if ( $.mobile.loadingMessage ) {
                    ...
                    theme = theme || $.mobile.loadingMessageTheme,
                        ...
                        $loader
                            .attr("class",
                            loaderClass + " ui-corner-all ui-body-" + ( theme || "a" ) + " ui-loader-" + ( textVisible ? "verbose" : "default" ) + ( textonly ? " ui-loader-textonly" : "" ))
                            .find("h1")
            ...
            initializePage    : function () {
                ...
                if ( !$.mobile.hashListeningEnabled || !$.mobile.path.stripHash(location.hash) ) {
                    $.mobile.changePage($.mobile.firstPage,
                        { transition: "none", reverse: true, changeHash: false, fromHashChange: true });
                }
